export default function defineAuthChallenge(event: any, context: any) {
  console.log(
    "defineAuthChallenge - Handling Cognito trigger DefineAuthChallenge_Authentication",
  );
  ...
  console.log(
    "defineAuthChallenge - Handled Cognito trigger DefineAuthChallenge_Authentication",
  );
  return event;
}
